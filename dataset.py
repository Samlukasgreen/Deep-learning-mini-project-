...
class UnifiedDesignDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.flight_base = ['Re','M_inf','alpha_deg']
        extra = []
        ...
        self.shape_cols  = ['B1','B2','B3','C1','C2','C3','C4','S1','S2','S3']  # 10
        self.meta_cols   = ['case_name','geom_name','CD','CL','Cmy']                 # kept but unused in cond

        expected = set(['case_name','geom_name','alt_kft','Re','M_inf','alpha_deg','beta_deg',
                        'CD','CL','Cmy','B1','B2','B3','C1','C2','C3','C4','S1','S2','S3'])
